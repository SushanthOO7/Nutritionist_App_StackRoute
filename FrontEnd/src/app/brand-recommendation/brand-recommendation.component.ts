...
export class BrandRecommendationComponent implements OnInit {
  ...
  constructor(public activatedRoute: ActivatedRoute, public persistService: PersistanceService, 
    public fetchService: FoodDataCentralService, public routerService:RouteService) { }
